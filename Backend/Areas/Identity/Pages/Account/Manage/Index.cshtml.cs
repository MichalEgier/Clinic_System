...
namespace WebApp1.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(PatientAccount user)
        {
            ...
            {
                Name = _db.GetPatient(user.AccountOwnerID).Name,
                Surname = _db.GetPatient(user.AccountOwnerID).Surname,
                Pesel = _db.GetPatient(user.AccountOwnerID).Pesel,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            //tutaj cos niby powinno byc wedlug poradnika Identity

            //ale wydaje mi sie niepotrzebne
